...
def get_jet_sys(fatjet,rho, year):
    year = get_UL_year(year)
    ...
    #print("JES correction1")
    algoname="AK8PFPuppi"

    map_name0=jec+"Total_"+algoname
    map_name1=jec+"Fragmentation_"+algoname
    map_name2=jec+"L1FastJet_"+algoname
    map_name3=jec+"L2Relative_"+algoname
    map_name4=jec+"L3Absolute_"+algoname
    map_name5=jec+"L2L3Residual_"+algoname

      #map_name="Summer22_22Sep2023_V2_MC_Total_AK8PFPuppi"
    jet_pt_raw=(1-fatjet.rawFactor)*fatjet.pt
    jes_corr_sys=cset[map_name0].evaluate(fatjet.eta, jet_pt_raw)    
    jes_corr_sys1=cset[map_name1].evaluate(fatjet.eta, jet_pt_raw)    
    jes_corr_corr1=cset[map_name2].evaluate(fatjet.area,fatjet.eta, jet_pt_raw,rho)    
    jes_corr_corr2=cset[map_name3].evaluate(fatjet.eta, jet_pt_raw)    
    jes_corr_corr3=cset[map_name4].evaluate(fatjet.eta, jet_pt_raw)    
    jes_corr_corr4=cset[map_name5].evaluate(fatjet.eta, jet_pt_raw)    

    jet_pt_up=(1+jes_corr_sys)*fatjet.pt
    jet_pt_down=(1-jes_corr_sys)*fatjet.pt
    print("jec",fatjet.pt/jet_pt_raw)
    print("jes_corr_L1Fastjet",jes_corr_corr1)
    print("jes_corr_L2Relative",jes_corr_corr2)
    print("jes_corr_L3Absolute",jes_corr_corr3)
    print("jes_corr_L2L3Residual",jes_corr_corr4)

    print("jec_sys_total",jes_corr_sys)
    print("jec_sys_fragmentation",jes_corr_sys1)

    print("jet pt",fatjet.pt)
    print("raw pt",jet_pt_raw)  
